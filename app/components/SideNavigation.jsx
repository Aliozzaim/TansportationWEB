        ...
        >
          <div className=" flex justify-between  gap-4 items-center align-middle !w-[174px]    ">
            <svg
              ...
              height="20"
              viewBox="0 0 20 20"
              fill={pathname === "/dashboard/offers" ? "#ff6438" : "none"}
              xmlns="http://www.w3.org/2000/svg"
            >
              <g opacity={` ${pathname == "/dashboard/offers" ? "1" : "0.5"}`}>
                <path
                  ...
                  fill={pathname === "/dashboard/offers" ? "#ff6438" : "white"}
                />
                <path
        ...
        >
          <div className=" flex justify-between  gap-4 items-center align-middle !w-[174px]  ">
            <svg
              ...
              viewBox="0 0 20 20"
              fill={` ${
                pathname == "/dashboard/conversations" ? "#FF6438" : "white"
              }`}
              xmlns="http://www.w3.org/2000/svg"
            >
              <g
                opacity={` ${
                  pathname == "/dashboard/conversations" ? "1" : "0.5"
                }`}
              >
                <path
        ...
        >
          <div className=" flex justify-between  gap-4 items-center align-middle !w-[174px]  ">
            <svg
              ...
              height="20"
              viewBox="0 0 20 20"
              fill={pathname == "/profile-edit" ? "#ff6438" : "white"}
              xmlns="http://www.w3.org/2000/svg"
            >
              <path
            ...
            <div id="nav-item" className="w-full text-start">
              <span
                id="nav-link"
                className={`${
                  pathname == "/profile-edit" ? "!text-[#ff6438]" : "text-white"
                } dssams40014 w-full`}
                href="home"
              >
                Profili Düzenle
        ...
        >
          <div className=" flex justify-between  gap-4 items-center align-middle !w-[174px]  ">
            <svg
              ...
              height="20"
              viewBox="0 0 20 20"
              fill={pathname === "/support" ? "#ff6438" : "white"}
              xmlns="http://www.w3.org/2000/svg"
            >
              <path
            ...
            <div id="nav-item" className="w-full text-start">
              <span
                id="nav-link"
                className={`${
                  pathname == "/support" ? "!text-[#ff6438]" : "text-white"
                } dssams40014 w-full`}
                href="support"
              >
                Destek
        ...
        >
          <div className=" flex justify-between  gap-4 items-center align-middle !w-[174px]  ">
            <svg
              ...
              height="20"
              viewBox="0 0 20 20"
              fill={pathname == "/posts" ? "#ff6438" : "white"}
              xmlns="http://www.w3.org/2000/svg"
            >
              <g opacity={pathname == "/posts" ? "1" : "0.5"}>
                <path
            ...
            <div id="nav-item" className="w-full text-start">
              <span
                id="nav-link"
                className={`${
                  pathname == "/posts" ? "!text-[#ff6438]" : "text-white"
                } dssams40014 w-full`}
                href="posts"
              >
                İlanlarım
          ...
          <div className=" flex justify-between  gap-4 items-center align-middle !w-[174px]  ">
            ...
            <div id="nav-item" className="w-full text-start">
              <span
                id="nav-link"
                className={`${
                  pathname == "/cars" ? "!text-[#ff6438]" : "text-white"
                } dssams40014 w-full`}
                href="cars"
              >
                Araçlarım
        ...
        >
          <div className=" flex justify-between  gap-4 items-center align-middle !w-[174px]  ">
            <svg
              ...
              height="20"
              viewBox="0 0 20 20"
              fill={pathname === "/reviews" ? "#ff6438" : "white"}
              xmlns="http://www.w3.org/2000/svg"
            >
              <g opacity={pathname === "/reviews" ? "1" : "0.5"}>
                <path
            ...
            <div id="nav-item" className="w-full text-start">
              <span
                id="nav-link"
                className={`${
                  pathname == "/reviews" ? "!text-[#ff6438]" : "text-white"
                } dssams40014 w-full`}
                href="reviews"
              >
                Değerlendirmelerim
